...
from lib.supervised.biased.sga.blocks import ObjectClassifierTransformer, ObjectAnticipation
...
class ObjProcessorDsgDetr(nn.Module):

    def __init__(self, mode='sgdet', obj_classes=None):
        super(ObjProcessorDsgDetr, self).__init__()
