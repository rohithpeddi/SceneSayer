...
def generate_ablation_context_recalls_latex_tables(context_results_json):
	for mode in modes:
		for train_num_future_frame in train_future_frame_loss_list:
			...
			for context_fraction in context_fraction_list:
				values_matrix = np.zeros((4, 12), dtype=np.float32)
...
if __name__ == '__main__':
	...
	# methods = ["sttran_ant", "dsgdetr_ant", "sttran_gen_ant", "dsgdetr_gen_ant", "ode", "sde_wo_bb", "sde_wo_recon",
	#            "sde_wo_gen_loss", "sde"]
	
	methods = ["sde_wo_bb", "sde_wo_recon", "sde_wo_gen", "sde"]
