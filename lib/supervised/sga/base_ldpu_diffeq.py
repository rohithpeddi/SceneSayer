...
class BaseLDPUDiffEq(nn.Module):
    ...
    def process_ff_rels(self, entry, testing=False):
    ...
    def process_context_fraction_rels(self, entry, context_fraction):
        ...
        return entry, end, num_frames, frames_ranges, global_output, pair_idx, im_idx, times

    def process_context_fraction_output_pred(self, entry, end, num_frames, frames_ranges, pair_idx, im_idx, ret, pred):
