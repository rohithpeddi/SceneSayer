...
class ObjSTTranAnt(ObjBaseTransformer):
	...
	def __init__(self,
		...
		self.obj_anti_temporal_transformer = None
		
		self.c_rel_compress = None
		self.anti_temporal_transformer = None
		self.s_rel_compress = None
		self.a_rel_compress = None
		self.spatial_transformer = None
		self.anti_positional_encoder = None
		self.obj_embed2 = None
		self.obj_embed = None
		self.vr_fc = None
		self.obj_fc = None
		self.subj_fc = None
	
	def init_cold_start(self):
	...
	def init_warm_start(self):
		...
		self.obj_embed2 = nn.Embedding(len(self.obj_classes), 200)
