...
ckpt = torch.load('/home/cse/msr/csy227518/scratch/Project/SG_sota_code/sota_eval/model_sgdet/model_15_lr4.tar')
model.load_state_dict(ckpt['state_dict'], strict=False)
model.to(device)
print('*'*50)
print('CKPT {} is loaded'.format(('/home/cse/msr/csy227518/scratch/Project/SG_sota_code/sota_eval/model_sgdet/model_15_lr4.tar')))
...
evaluator1 = BasicSceneGraphEvaluator(mode='sgdet',
...
evaluator2 = BasicSceneGraphEvaluator(mode='sgdet',
                                    AG_object_classes=object_class,
                                    AG_all_predicates=relationship_classes,
                                    AG_attention_predicates=attention_relationships,
                                    AG_spatial_predicates=spatial_relationships,
...
evaluator3 = BasicSceneGraphEvaluator(mode='sgdet',
                                    AG_object_classes=object_class,
                                    AG_all_predicates=relationship_classes,
                                    AG_attention_predicates=attention_relationships,
                                    AG_spatial_predicates=spatial_relationships,
...
for epoch in range(1):
    ...
    with torch.no_grad():
        ...
        for batch in val_dataloader:
            ...
            output["entry"] = entry
            pickle.dump(output,open("./predictions/"+gt_annotation[0][0]["frame"][0].split(".")[0]+".pkl",'wb'))
