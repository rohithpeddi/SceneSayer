...
import torch
from lib.supervised.dysgg.blocks import ObjectClassifierMLP, PositionalEncoding, EncoderLayer, Encoder
...
class DySTTran(nn.Module):
	...
	def forward(self, entry):
		...
		rel_ = self.temporal_transformer(sequence_features_position_embedded, src_key_padding_mask=masks.cuda(), mask=future_mask)
